...
\addbibresource{thomsonapplet.bib}
\addbibresource{ilibarra.bib}
\addbibresource{parallel.bib}
...
\makeatother
\renewcommand{\algorithmiccomment}[1]{\hfill\textit{\color{blue}{$\#$#1}}}
